class VmsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to vms_path, status: :see_other, notice: "Vm was successfully destroyed." }
  ...
  private
    ...
    def vm_params
      params.require(:vm).permit(:datacenter_id, :mips, :ram, :storage, :bandwidth)
    end
end
